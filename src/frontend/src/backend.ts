...
import type { ExternalBlob as _ExternalBlob, SensitiveFile as _SensitiveFile, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createOrder(arg0: SchroedingkOrder): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getAllOrders(): Promise<Array<SchroedingkOrder>> {
        if (this.processError) {
            try {
    ...
    async getAllSensitiveFiles(): Promise<Array<[bigint, SensitiveFile]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllSensitiveFiles();
    ...
    async getAllSensitiveWords(): Promise<Array<[bigint, string]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllSensitiveWords();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getOrder(arg0: bigint): Promise<SchroedingkOrder> {
        if (this.processError) {
            try {
    ...
    async removeSensitiveWord(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeSensitiveWord(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveSensitiveWord(arg0: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.saveSensitiveWord(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateOrder(arg0: bigint, arg1: SchroedingkOrder): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateSensitiveWord(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateSensitiveWord(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadSensitiveFile(arg0: ExternalBlob, arg1: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadSensitiveFile(await to_candid_ExternalBlob_n18(this._uploadFile, this._downloadFile, arg0), arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_SensitiveFile_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SensitiveFile): Promise<SensitiveFile> {
...
async function from_candid_tuple_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [bigint, _SensitiveFile]): Promise<[bigint, SensitiveFile]> {
    return [
        value[0],
        await from_candid_SensitiveFile_n12(_uploadFile, _downloadFile, value[1])
    ];
}
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[bigint, _SensitiveFile]>): Promise<Array<[bigint, SensitiveFile]>> {
